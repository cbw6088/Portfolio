  ...
  return (
    <section id="strengths" className="py-12">
      ...
      <div className="space-y-6 text-sm text-stone-700 dark:text-stone-300">
        <div className="rounded-lg border border-stone-200 bg-white/60 px-4 py-3 dark:border-stone-700 dark:bg-stone-900/60">
          <p className="text-[11px] font-semibold tracking-[0.18em] uppercase text-amber-600 mb-1">
            01 · Migration (Customer Portal)
          </p>
          <h3 className="font-semibold text-stone-900 mb-2 dark:text-stone-100">
            레거시 포털을 Next.js 기반 운영 서비스로 전환
          </h3>
          <div className="space-y-1.5">
            <p>
              <span className="font-medium text-stone-900 dark:text-stone-100">핵심 역량</span>
            ...
            <p>
              <span className="font-medium text-stone-900 dark:text-stone-100">성과</span>
              <span className="text-stone-600 dark:text-stone-300">
                {" "}
          ...
          <div className="mt-3 flex justify-start">
            <Link
              href="https://portfolio-cbw.vercel.app/project/work-customer-portal"
        ...
        <div className="rounded-lg border border-stone-200 bg-white/60 px-4 py-3 dark:border-stone-700 dark:bg-stone-900/60">
          ...
          <div className="mt-3 flex justify-start">
            <Link
              href="https://portfolio-cbw.vercel.app/project/work-brand-renewal"
              className="text-amber-600 hover:text-amber-700 dark:hover:text-amber-400 text-sm font-medium underline-offset-2 hover:underline"
            >
        ...
        <div className="rounded-lg border border-stone-200 bg-white/60 px-4 py-3 dark:border-stone-700 dark:bg-stone-900/60">
          ...
          <div className="mt-3 flex justify-start">
            <Link
              href="https://portfolio-cbw.vercel.app/project/quizgen"
              className="text-amber-600 hover:text-amber-700 dark:hover:text-amber-400 text-sm font-medium underline-offset-2 hover:underline"
            >
              QuizGen 프로젝트 바로가기 →
            </Link>
