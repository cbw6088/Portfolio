...
import { INTRO_EDUCATION } from "../constants";

export default function IntroEducation() {
  return (
    <section id="education" className="py-12 border-b border-stone-200 dark:border-stone-800">
      <h2 className="font-semibold text-lg text-stone-800 mb-4 dark:text-stone-100">Education</h2>
      <ul className="space-y-4">
        {INTRO_EDUCATION.map((item, i) => (
