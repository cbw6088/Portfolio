...
export const STUDY_POSTS: StudyPost[] = [
  { id: "2026-07-06", categoryId: "certificate", title: "[정처기 실기] 3. SW 개발", date: "2026-07-06", slug: "2026-07-06", excerpt: "정처기 감자 실기 이론 압축 요약 — 테스트 커버리지, 블랙박스, 테스트 자동화·레벨, 인터페이스 보안 등" },
