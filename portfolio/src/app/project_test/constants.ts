...
export const PROJECTS: ProjectItem[] = [
  {
    ...
    role: "Front-End(팀장)",
    description: "PDF 파일을 업로드하고 간편하게 나만의 문제지를 만들어 퀴즈를 풀어볼 수 있는 웹사이트",
    tech: {
      language: "TypeScript",
  ...
  },
  {
    ...
    platform: "Web",
    role: "Front-End",
    description: "현재 재직 중인 회사에서 진행한 프로젝트로, 상세 내용 및 스크린샷은 보안상 생략합니다.",
  },
];
